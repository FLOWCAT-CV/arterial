...
for case_id in sorted(os.listdir(database_dir)):
    ...
    # os.system("xvfb-run --auto-servernum --server-num=1 /home/vhir/anaconda3/envs/arterial_env/bin/python /home/vhir/github/arterial/perform_analysis.py -case_dir {}".format(case_dir))